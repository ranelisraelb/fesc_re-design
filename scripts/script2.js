...
function drawThirdConsumption() {
    ...
    var options = {
        'title': 'Renewable Energy Consumption In Florida (1996-2015)',
        'width': 400,
        'height': 300,
    };
...
window.onload = function () {
    ...
    document.getElementById('1960-1978-trigger-con').addEventListener('click', function () {
        ...
        document.getElementById('1996-2015-con').innerHTML = ""
    ...
    document.getElementById('1996-2015-trigger-con').addEventListener('click', function () {
        document.getElementById('1960-1978-con').innerHTML = ""
        document.getElementById('1978-1996-con').innerHTML = ""
        document.getElementById('1996-2015-con').innerHTML = ""
