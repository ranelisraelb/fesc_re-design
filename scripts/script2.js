...
google.charts.setOnLoadCallback(drawConsumption);
...
function drawConsumption() {
    ...
    var chart = new google.visualization.LineChart(document.getElementById('all-con'));
...
window.onload = function () {
    ...
    document.getElementById('all-trigger-con').addEventListener('click', function () {
        document.getElementById('all-con').innerHTML = ""
